...
public class CalendarActivity extends baseActivity implements OnClickListener,SimpleGestureListener {
		...
		//		ArrayAdapter<String> adapter_top = new ArrayAdapter<String>(this,
			//			android.R.layout.simple_list_item_1,daysofweek );
				
			//	daysofweekView.setAdapter(adapter_top);
		...
		public class GridCellAdapter extends BaseAdapter implements OnClickListener
			{
				...
				public View getView(int position, View convertView, ViewGroup parent)
					...
					//	gridcell.setLayoutParams(new GridView.LayoutParams((int)px, (int)px));
						//gridcell.setScaleX(gridcell.SCALE_X.)
						gridcell.setOnClickListener(this);
					//	gridcell.setLayoutParams(new LayoutParams((int)px, (int)px));
						// ACCOUNT FOR SPACING
					//	gridcell.setHeight((int) 65);
